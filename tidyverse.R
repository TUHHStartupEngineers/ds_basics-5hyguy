...
library(writexl)
# 2.0 Importing Files ----
bikes <- read_excel("Documents/dataanalytics/Untitled/ds_basics-5hyguy/00_data/bikes.xlsx")
orderLines <- read_excel("Documents/dataanalytics/Untitled/ds_basics-5hyguy/00_data/orderlines.xlsx")
bikeshops <- read_excel("Documents/dataanalytics/Untitled/ds_basics-5hyguy/00_data/bikeshops.xlsx")
# 3.0 Examining Data ----
...
bikeshop_orderlines_wrangled %>% write_xlsx("Documents/dataanalytics/Untitled/ds_basics-5hyguy/00_data/bike_orderlines.xlsx")
bikeshop_orderlines_wrangled %>% write_csv("Documents/dataanalytics/Untitled/ds_basics-5hyguy/00_data/bike_orderlines.csv")
bikeshop_orderlines_wrangled %>% write_rds("Documents/dataanalytics/Untitled/ds_basics-5hyguy/00_data/bike_orderlines.rds")
